...
import com.manhdd.nuce.khoamanhinhnhandangkhuanmat.manhinh.ManHinhNhanDang;

import org.opencv.core.Mat;

// All computations is done in an asynchronous task, so we do not skip any frames
public class NativeMethods {
    private static final String TAG = ManHinhNhanDang.class.getSimpleName() + "/" + NativeMethods.class.getSimpleName();
    ...
    public static class TrainFacesTask extends AsyncTask<Void, Void, Boolean> {
         ...
         */
        public TrainFacesTask(Mat images, Mat classes, Callback callback) {
            this.images = images;
